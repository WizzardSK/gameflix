...
fuse-zip -d /userdata/rom/TOSEC/Atari/8bit/Games/[ATR]/Atari\ 8bit\ -\ Games\ -\ \[ATR].zip /userdata/roms/atari800/online -o nonempty -omodules=iconv,from_code=$charset1,to_code=$charset2
mount -o bind /userdata/thumbs/Atari\ -\ 8-\bit/Named_Snaps /userdata/roms/atari800/images

echo "Mounting amstradcpc"
fuse-zip -d /userdata/rom/TOSEC/Amstrad/CPC/Games/[DSK]/Amstrad\ CPC\ -\ Games\ -\ \[DSK].zip /userdata/roms/amstradcpc/online -o nonempty -omodules=iconv,from_code=$charset1,to_code=$charset2
mount -o bind /userdata/thumbs/Amstrad\ -\ CPC/Named_Snaps /userdata/roms/amstradcpc/images

echo "Mounting zxspectrum"
fuse-zip -d /userdata/rom/TOSEC/Sinclair/ZX\ Spectrum/Games/[Z80]/Sinclair\ ZX\ Spectrum\ -\ Games\ -\ \[Z80].zip /userdata/roms/zxspectrum/online -o nonempty -omodules=iconv,from_code=$charset1,to_code=$charset2
