...
mkdir -p /userdata/zip/atari2600roms /userdata/roms/atari2600/Atari\ 2600\ ROMS /userdata/{rom,roms,thumb,thumbs,thumbnails,zip} /userdata/system/.cache/{httpdirfs,ratarmount,rclone} /userdata/thumbs/TIC-80
rclone mount thumbs:Data/share/thumbs /userdata/thumbnails --vfs-cache-mode full --daemon --config=/userdata/system/rclone.conf --allow-non-empty
