...
mkdir -p ~/myrient ~/roms ~/iso ~/gameflix ~/share/system/.cache/ratarmount ~/share/system/.cache/rclone ~/share/zip/atari2600roms ~/roms/atari2600/Atarimania
...
bindfs ~/share/zip/atari2600roms/ROMS ~/roms/atari2600/Atarimania
