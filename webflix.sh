...
wget -nv -O ~/.config/rclone/rclone.conf https://raw.githubusercontent.com/WizardSK/gameflix/main/rclone.conf
...
csv=$(curl -s https://raw.githubusercontent.com/WizardSK/gameflix/main/platforms.csv | tail -n +2)
