...
if [ ! -f /recalbox/share/system/.emulationstation/systemlist.xml ]; then wget -O /recalbox/share/system/systemlist.xml https://raw.githubusercontent.com/WizzardSK/gameflix/main/recalbox/share/system/systemlist.xml; fi
