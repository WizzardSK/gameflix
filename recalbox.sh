...
wget -O /recalbox/share/system/.emulationstation/systemlist.xml https://raw.githubusercontent.com/WizzardSK/gameflix/main/recalbox/share/system/systemlist.xml
