...
For Batocera, you need to copy [custom.sh](custom.sh) file to your system folder in shared drive. It will launch automatically at system boot. You also need rclone binary in system folder and rclone config file in ./config/rclone folder in system folder.
